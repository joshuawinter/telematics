...
'
GIS_FILE1=/usr/pgsql-9.2/share/contrib/postgis-2.0/postgis.sql
GIS_FILE2=/usr/pgsql-9.2/share/contrib/postgis-2.0/spatial_ref_sys.sql
...
sudo -u $USER_NAME createdb $DB_NAME -E 'UTF8' -O $USER_NAME 2> /dev/null
